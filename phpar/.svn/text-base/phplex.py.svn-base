...
tokens = reserved + unparsed + (
    ...
    'IS_NOT_EQUAL', 'IS_IDENTICAL', 'IS_NOT_IDENTICAL','BACKTICKS',
...
def t_OPEN_TAG(t):
    r'<[?%]((php|PHP|Php|PHp|pHP|phP|pHp|pHP|PhP|Php[ \t\r\n]?)|=)?'
...
class FilteredLexer(object):
    ...
    @lineno.setter
    def lineno(self, value): #@DuplicatedSignature
    ...
    @lexpos.setter
    def lexpos(self, value): #@DuplicatedSignature
